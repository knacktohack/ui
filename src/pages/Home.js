...
const Home = () => {
  return (
    <div className='h-screen w-4/12 flex flex-col justify-center items-center gap-10 mx-auto'>
      ...
      <Link to={'/chat'} className='text-4xl text-white font-bold bg-green-primary p-10  w-full text-center'>
            Chat
      </Link>
      <Link to={'/admin'} className='text-4xl text-white font-bold bg-orange-primary p-10  w-full text-center'>
            Admin Panel
      </Link>
    </div>
  )
